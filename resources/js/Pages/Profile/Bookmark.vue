    ...
    <ProfileLayout section="Bookmark">
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <h1>My Bookmarks</h1>
                <Message :closable="false">Your bookmarks are saved temporarily and will disappear if you do not save them to your account. Login or create a new account now!</Message>
